                ...
                <div className="footer-content">
                    ...
                    <div className="footer-section company-section">
                        <div className="company-info">
                            ...
                            <div className="social-links">
                                ...
                                <a href="https://wa.me/message/HBNN47EW2DUXP1" className="social-link" aria-label="WhatsApp" target="_blank" rel="noopener noreferrer">
                                    <svg viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <div className="footer-section">
                        ...
                        <ul className="footer-links">
                            ...
                            <li><Link to="/products">Engines</Link></li>
                            <li><Link to="/products">Powerboxes</Link></li>
                            <li><Link to="/products">Differentials</Link></li>
                        </ul>
                    </div>
